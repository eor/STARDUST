...
if __name__ == "__main__":
    ...
    if case==1:
        ...
        sed.plot_SED(fileName=[f1 ,f2 ,f3], logX=True, logY=True, yLimit=[2e51, 1e57], xLimit=[1e1 ,1e4], legend=['BB 10' ,'BB 200' ,'BB 700'] ,legendLoc=1, altFileName="SED_comparison_BB_1.pdf")
    ...
    if case==3:
        ...
        sed.generate_SED_stars_IMF(haloMass=10**logM, redshift=z, eLow=10.4, eHigh=1.e4, N=1000,  logGrid=False,
                               ...
                               fileName=a)
        sed.plot_SED(fileName=a, logX=True, logY=True, yLimit=[1e25, 1e55], legend='IMF' ,legendLoc=1, altFileName="SED_IMF_test.pdf")
